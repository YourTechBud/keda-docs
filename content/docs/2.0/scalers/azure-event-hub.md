...
The `connection`/`connectionFromEnv` value is the name of the environment variable your deployment uses to get the Event Hub connection string which is appended with the Event Hub name using Entity Path variable. `storageConnection`/`storageConnectionFromEnv` is the name of the environment variable your deployment uses to get the Storage connection string.
