...
- `connection`/`connectionFromEnv` postgreSQL connection string that should point to environment variable with valid value
...
- `password:`/`passwordFromEnv` Password for postgresql user
...
- `connection`/`connectionFromEnv` - Connection string for postgreSQL database

**Password Authentication:**

- `password`/`passwordFromEnv` - Password for configured user to login to postgreSQL database
variables.
